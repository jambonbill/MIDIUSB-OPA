...
void ccParam(byte num, byte val) {
  ...
  switch (num) {
    ...
    case 74://OP4 OPA_OP_FEEDBACK (only for op4)
    ...
    case 80:
      ...
      opa.storeInternal(OPA_PROGRAM,val);
      break;
    
    case 81:
      //x51| 81| loadInternal (OPA_PROGRAMS program, uint8_t slot);
      opa.loadInternal(OPA_PROGRAM,val);
      break;
    
    case 82:
      //x52| 82| allNotesOff(OPA_PROGRAMS program);
      opa.allNotesOff(OPA_PROGRAM);
      break;
